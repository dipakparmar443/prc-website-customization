...
class Tribe__Tickets_Plus__Editor__Provider extends \TEC\Common\Contracts\Service_Provider {
	 ...
	 *
	 * @since 4.9
	 * @since TBD Removed conditional registration of blocks. They are enqueued on block editor action so they can register always.
	 */
	 ...
	 *
	 * @since 5.6.9
	 * @deprecated TBD We are always registering the assets now, so this is deprecated.
	 *
	 * @return bool
	 */
