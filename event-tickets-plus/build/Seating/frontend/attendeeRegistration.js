...
// CONCATENATED MODULE: ./src/Tickets_Plus/Seating/app/frontend/attendeeRegistration/ar-page.js
 ...
 */
function doNotInterruptLeavingARPage(dom) {
  dom = dom || document;
  const el = dom.querySelectorAll(".tribe-tickets__registration-submit");
  el.forEach(e => e.addEventListener("click", () => Object(external_tec_tickets_seating_frontend_session_["setIsInterruptable"])(false)));
}
...
// CONCATENATED MODULE: ./src/Tickets_Plus/Seating/app/frontend/attendeeRegistration/hook-callbacks.js
...
const formatSeatLabel = seatLabel => {
  return seatLabel ? ` - ${Object(external_wp_i18n_["__"])('Seat', 'event-tickets-plus')} ${seatLabel}` : '';
};
 ...
 */
const filterTicketTemplateSeatLabels = function (data, ticketId, offSet) {
  let dom = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  dom = dom || document;
...
// CONCATENATED MODULE: ./src/Tickets_Plus/Seating/app/frontend/attendeeRegistration/filters.js


Object(external_wp_hooks_["addFilter"])('tec.tickets-plus.ticket-getTemplateData', 'tec.tickets.seating', filterTicketTemplateSeatLabels);
// CONCATENATED MODULE: ./src/Tickets_Plus/Seating/app/frontend/attendeeRegistration/index.js


// We are registering JS filters in the ./filters file so we want it to be included in the build.

Object(external_tec_tickets_seating_utils_["onReady"])(() => doNotInterruptLeavingARPage());
